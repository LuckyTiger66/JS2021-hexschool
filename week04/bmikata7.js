...
function showHistoryData() {
  ...
  console.log(`您總共計算 ${bmiHistoryData.length} 次 BMI 紀錄，最後一次 BMI 指數為 ${lastestData.bmi}，體重${bmiStatesData[lastestData.bmiState].state}！健康指數為${bmiStatesData[lastestData.bmiState].color}！`);
}
