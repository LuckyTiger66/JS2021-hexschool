...
function showHistoryData() {
  let lastData = bmiHistoryData[bmiHistoryData.length-1]
  console.log(`「您總共計算 ${bmiHistoryData.length} 次 BMI 紀錄，最後一次 BMI 指數為 ${lastData.bmi}，體重${bmiStatesData[lastData.bmiState].state}！健康指數為${bmiStatesData[lastData.bmiState].color}！」`);
}
// 第一組資料測試：
// printBmi(178, 20) 
// printBmi(178, 70) 
